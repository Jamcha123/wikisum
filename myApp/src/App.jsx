...
function AddWiki(){
  ...
  useEffect(() => {
    ...
    forms.addEventListener("submit", (e) => {
      ...
      axios.get(link, {
        ...
        const $ = cheerio.load(new XMLSerializer().serializeToString(value["data"]))
        let data = $("body").text()
  ...
  return(
    <div className="relative w-[85%] h-[100vh] m-auto p-[0] flex flex-col align-middle justify-center text-center ">
      <motion.div id="box" initial={{height: 10 + "vh"}} animate={{height: active? 80 + "vh" : 10 + "vh"}} transition={{type: "keyframes", duration: 2}} className="w-[100%] h-[10vh] m-0 p-[0] relative flex flex-col align-middle justify-center text-center bg-slate-800 ">
        ...
        <motion.div id="text" initial={{scaleY: 0, translateY: 100 + "%"}} animate={{scaleY: active? 1 : 0, translateY: active? 0 : 100 + "%"}} transition={{type: "keyframes", duration: 2}} className="w-[100%] h-[80vh] m-auto p-[0] relative bg-transparent flex flex-col align-middle justify-center text-center bg-slate-600 ">

        </motion.div>
      </motion.div>
      <motion.div className="w-[100%] min-h-[10vh] max-h-[fit-content] m-0 p-[0] relative flex flex-row align-middle justify-center text-center bg-slate-600 ">
